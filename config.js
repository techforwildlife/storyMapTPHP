var config = {
    ...
    chapters: [
...

        {
            ...
            description: 'Researchers combined data on the location, site conditions, and budgets, with a machine learning model, trained on past land cover change, to predict the likelihood of future tree cover loss in plantation areas. They found over half of the state’s tree planting budget is wasted on plantations that are unlikely to survive and/or are poorly designed to achieve the state’s goal of increasing forest cover. Reasons for tree mortality as predicted by the study: 1. Trees were planted in non-forest unproductive areas. 2. Trees were planted in areas with extensive southern exposure. 3. Forests with contested land tenure. 4. Forests that have more than 40% canopy cover.',
            location: {
                center: [76.513467, 31.692998],
                zoom: 7,
                pitch: 20,
